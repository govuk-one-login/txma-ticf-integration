...
export const TEST_ZENDESK_FIELD_DATA_PATHS = '1'
export const TEST_ZENDESK_FIELD_DATE_FROM = '2'
export const TEST_ZENDESK_FIELD_DATE_TO = '3'
export const TEST_ZENDESK_FIELD_EVENT_IDS = '4'
export const TEST_ZENDESK_FIELD_IDENTIFIER_TYPE = '5'
export const TEST_ZENDESK_FIELD_JOURNEY_IDS = '6'
export const TEST_ZENDESK_FIELD_PII_TYPES = '7'
export const TEST_ZENDESK_FIELD_SESSION_IDS = '8'
export const TEST_ZENDESK_FIELD_USER_IDS = '9'
