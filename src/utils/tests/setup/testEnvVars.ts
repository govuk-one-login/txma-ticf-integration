...
process.env.ZENDESK_FIELD_DATA_PATHS = '1'
process.env.ZENDESK_FIELD_DATE_FROM = '2'
process.env.ZENDESK_FIELD_DATE_TO = '3'
process.env.ZENDESK_FIELD_EVENT_IDS = '4'
process.env.ZENDESK_FIELD_IDENTIFIER_TYPE = '5'
process.env.ZENDESK_FIELD_JOURNEY_IDS = '6'
process.env.ZENDESK_FIELD_PII_TYPES = '7'
process.env.ZENDESK_FIELD_SESSION_IDS = '8'
process.env.ZENDESK_FIELD_USER_IDS = '9'
