...
process.env.PERMANENT_AUDIT_BUCKET_NAME = TEST_PERMANENT_BUCKET_NAME
...
process.env.ZENDESK_FIELD_ID_DATES = TEST_ZENDESK_FIELD_ID_DATES.toString()
...
process.env.DECRYPTION_LAMBDA_ARN = TEST_DECRYPTION_LAMBDA_ARN

process.env.GENERATOR_KEY_ID = TEST_GENERATOR_KEY_ID

process.env.EMAIL_TO_SLACK_SNS_TOPIC_ARN = EMAIL_TO_SLACK_SNS_TOPIC_ARN
